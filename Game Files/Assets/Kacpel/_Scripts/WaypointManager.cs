...
public class WaypointManager : MonoBehaviour { // jak skonczysz debugowac, to zamien na prywatne wszystko co sie da
    ...
    void Start()
    {
        ...
        player_object.GetComponent<CharacterController>().changed_closest_waypoint = true;
    }
    ...
    void Update()
    {
        ...
        {
            dijsktra();
            player_object.GetComponent<CharacterController>().changed_closest_waypoint = false;
        }
